...
```text
.
├── index.html          # Main HTML structure & OSRS UI layout
├── fonts/
│   ├── runescape.tff/  # font used across the page
├── assets/
│   ├── images/         # Images include the background image, and screenshots of my OSRS account
